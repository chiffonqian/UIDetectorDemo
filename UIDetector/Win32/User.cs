...
namespace Win32Native
{
	...
	public class User
	{
		...
		[DllImport("user32")] public static extern HWND FindWindow(string lpClassName, string lpWindowName);
		[DllImport("user32")] public static extern HWND FindWindowEx(HWND hwnd1, HWND hwnd2, string lpsz1, string lpsz2);
        ...
        [DllImport("user32")] public static extern int GetAncestor(HWND hwnd, int flags);
